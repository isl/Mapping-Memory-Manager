                        ...
                        if (userCanWrite && (isUnpublished || isRejected)) {
                            if (isSaved && lockedBy != null) {
                                if (lockedBy.equals(this.username) == false) {
                                    ...
                                    hresponse.sendRedirect(systemURL + "/SystemMessages?message=" + displayMsg + "&file=" + xmlId + "&lang=" + lang + "&feXMLEditor=yes");
                                    ...
                                    System.out.println(displayMsg);
                                    hresponse.sendRedirect(systemURL + "/SystemMessages?message=" + displayMsg + "&file=" + xmlId + "&lang=" + lang + "&feXMLEditor=yes&type=" + type + "&category=" + category + "&link=yes");
//
...
//                        boolean hasDependants = dbf.exist("//admin/refs_by/ref_by[@published='yes']");
                        ...
                        if (rights.equals("guest") || rights.equals("sysadmin")) {
                            ...
                            System.out.println(displayMsg);
                            hresponse.sendRedirect(systemURL + "/SystemMessages?message=" + displayMsg + "&file=" + xmlId + "&lang=" + lang + "&feXMLEditor=yes&type=" + type);
                    ...
                    if (rights.equals("guest") || rights.equals("sysadmin")) {
                        displayMsg = "ACCESS_DENIED";
                        System.out.println(displayMsg);
                        hresponse.sendRedirect(systemURL + "/SystemMessages?message=" + displayMsg + "&file=" + xmlId + "&lang=" + lang);
